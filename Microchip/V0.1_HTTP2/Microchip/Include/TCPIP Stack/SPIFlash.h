...
void SPIFlashGetArray(DWORD dwAddress, BYTE *vData, WORD wLength);
void SPIFlashPut(DWORD dwAddress, BYTE vData);
void SPIFlashPutArray(DWORD dwAddress, BYTE *vData, WORD wLength);
